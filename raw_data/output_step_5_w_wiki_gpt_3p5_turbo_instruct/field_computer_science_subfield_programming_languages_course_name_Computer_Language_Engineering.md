...
- **Gemeinsame Körperschaftsdatei:** A standardized reference system used in Germany for identifying organizations.
- **GKD references between data:** A system for referencing data within the Gemeinsame Körperschaftsdatei.
